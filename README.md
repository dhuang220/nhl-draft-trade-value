...
3. **Trade grader** - combines both models to value either side of any NHL trade from the 1918-2024 trade history dataset (highest confidence for the 2016-17 season, lower confidence elsewhere via a career-value fallback - see below), plus hypothetical trades built from today's rosters using live NHL data.
